    ...
    <div>
        ...
        <div className="container">
            <div className="left">
                ...
                <input type="text" placeholder='Enter Credit' value={cre} onChange={(e)=>setCre(e.target.value)}/><br/><br/> <br />
                <button id='bt1' onClick={handleAdd} >Add Deposite</button> <br /><br /><br />  
            ...
            <input type="text" placeholder='Enter Debit' value={deb} onChange={(e)=>setDeb(e.target.value)} className='i1'/>
            <input type="text" placeholder='Enter Reason' value={res} onChange={(e)=>setRes(e.target.value)} className='i1'/>
